...
def get_data_loaders(batch_size=8, imbalance_factor=1.0):
    data_dir = './data'  # Ensure the correct path is specified here
    print("Loading data...")
...
if __name__ == "__main__":
    batch_size = 32  
    imbalance_factor = 1.0  # Factor by which to increase imbalance. 1.0 is balanced, >1 increases imbalance
